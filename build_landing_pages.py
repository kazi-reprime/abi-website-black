...
<link rel="stylesheet" href="%sassets/css/landing.css?v=26">
...
<script src="/assets/js/effects.js?v=26" defer></script>
<script src="%sassets/js/landing.js?v=26" defer></script>
</body>

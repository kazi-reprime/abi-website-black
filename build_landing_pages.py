...
<link rel="stylesheet" href="%sassets/css/landing.css?v=27">
...
<script src="/assets/js/effects.js?v=27" defer></script>
<script src="%sassets/js/landing.js?v=27" defer></script>
</body>
